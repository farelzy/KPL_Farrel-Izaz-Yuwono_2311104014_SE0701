class SimpleDataBase {
    ...
    addNewData(data) {
        ...
        this.inputDates.push(new Date().toLocaleString());
    }

    printAllData() {
        console.log("Data yang tersimpan:");
        this.storedData.forEach((data, index) => {
            console.log(`${index + 1}. ${data} (Disimpan pada: ${this.inputDates[index]})`);
        });
    }
}
...
database.addNewData(typed1);
database.addNewData(typed2);
database.addNewData(typed3);
